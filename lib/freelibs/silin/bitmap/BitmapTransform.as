...
package  silin.bitmap
{
	...
	public class BitmapTransform
	{
		...
		{
			trace ("BitmapTransform is a static class and should not be instantiated.")
		}
		/**
		...
		*/
		 ...
		 *
		 */
		public static function colorizeBitmap(bmd:BitmapData, colors:Array, channels:int=7):void
		{
